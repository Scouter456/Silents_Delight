...
public class SDFoods {
    ...
    public static final FoodProperties BAKED_WARDEN_EAR_ON_A_STICK = new FoodProperties.Builder()
            .nutrition(6)
            .saturationMod(0.6F)
            //.effect(() -> new MobEffectInstance(SDEffects.ONE_OF_US.get(), SHORT_DURATION, 0), 1.0F)
            .effect(() -> new MobEffectInstance(SDEffects.WARDENS_SENSE.get(), BRIEF_DURATION, 0), 1.0F)
            .build();
    ...
    public static final FoodProperties SCULK_SENSOR_TENDRIL_ROLL = new FoodProperties.Builder()
            .nutrition(12)
            .saturationMod(0.6f)
            //.effect(() -> new MobEffectInstance(SDEffects.ONE_OF_US.get(), LONG_DURATION, 0), 1.0F)
            .build();
    ...
    public static final FoodProperties SCULK_SENSOR_TENDRIL_SLICE = new FoodProperties.Builder()
            ...
            .saturationMod(0.5f)
            .fast()
            //.effect(() -> new MobEffectInstance(SDEffects.ONE_OF_US.get(), BRIEF_DURATION, 0), 1.0F)
            .build();
    ...
    public static final FoodProperties SCULK_SENSOR_SPRINKLES = new FoodProperties.Builder()
            ...
            .fast()
            //.effect(() -> new MobEffectInstance(SDEffects.ONE_OF_US.get(), LONG_DURATION, 0), 1.0F)
            .effect(() -> new MobEffectInstance(SDEffects.WARDENS_SENSE.get(), SHORT_DURATION, 0), 1.0F)
            .build();
    ...
    public static final FoodProperties HEARTBURGER = new FoodProperties.Builder()
            ...
            .fast()
            //.effect(() -> new MobEffectInstance(SDEffects.ONE_OF_US.get(), LONG_DURATION, 0), 1.0F)
            .effect(() -> new MobEffectInstance(SDEffects.WARDENS_SENSE.get(), LONG_DURATION, 0), 1.0F)
